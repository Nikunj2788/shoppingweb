    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-3 logo-holder"> 
          <!-- ============================================================= LOGO ============================================================= -->
          <div class="logo"> <a href="myaccountsel.jsp"> <img src="assets/images/logo.png" alt="logo"> </a> </div>
          <!-- /.logo --> 
          <!-- ============================================================= LOGO : END ============================================================= --> </div>
        <!-- /.logo-holder -->
          ...
          <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
            <div class="nav-outer">
              <ul class="nav navbar-nav">
                <li class="active dropdown"> <a href="myaccountsel.jsp">Home</a> </li>
                <li class="dropdown yamm mega-menu"> <a href="myaccountsel.jsp" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">Clothing</a>
...
<div class="breadcrumb">
  ...
  <%
		List<product> list = productdao.getAllData();
	%>
		...
		<table class="table">
			<thead>
				<tr>
					...
					<th class="cart-edit item"><a href=""></a>Edit</th>
					<th class="cart-qty item">product category</th>
					<th class="cart-sub-total item">product Prize</th>
				</tr>
			</thead><!-- /thead -->
			<%
								for (product p : list) {
			...
			<tbody>				
				<tr>
					<td class="romove-item"><a href="productcontroller"title="cancel" class="icon"><i class="fa fa-trash-o"  ></i></a></td>
					<td class="cart-image">
					...
					<td class="cart-product-name-info">
						<h4 class='cart-product-description'><a href="#"><%=p.getP_name() %></a></h4>
						<div class="row">
							<div class="col-sm-12">
					...
					<td class="cart-product-edit"><a href="editproduct.jsp" class="product-edit">Edit</a></td>
...
<!-- 						<div class="quant-input">
 -->				                <!-- <div class="arrows">
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price"><%=p.getP_price() %></span></td>

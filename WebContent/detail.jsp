      ...
      <div class="header-top-inner">
        <div class="cnt-account">
          <ul class="list-unstyled">
            ...
            <li class="wishlist"><a href="my-wishlist.jsp"><span>Wishlist</span></a></li>
            <li class="header_cart hidden-xs"><a href="shopping-cart.jsp"><span>My Cart</span></a></li>
            <li class="check"><a href="checkout.jsp"><span>Checkout</span></a></li>
             <div class="cnt-block">
						...
						<div class="product-info">
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="add-btn">
										<a href="checkout.jsp" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> ADD TO CART</a>
									</div>

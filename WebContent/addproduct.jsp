...
<body class="cnt-home">
  <%
          seller s = null;
		if (session != null) {
			s = (seller) session.getAttribute("abc");
		} else {
			response.sendRedirect("loginsel.jsp");
		}
	%>
          ...
          <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
            <div class="nav-outer">
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown"> <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown">Account</a>
                        ...
                        <div class="row">
                          <div class="col-xs-12 col-menu">
                            <ul class="links">
                              ...
                              <li><a href="singleproduct.jsp">Product Detail</a></li>
...
<div class="col-md-6 col-sm-6 sign-in">
	...
	<form class="register-form outer-top-xs" action ="productcontroller" method ="post" role="form" enctype="multipart/form-data">
		...
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    <label class="info-title" for="exampleInputPassword1">Product Name <span>*</span></label>
		    <input type="text" name ="p_name"class="form-control unicase-form-control text-input" id="exampleInputPassword1" >
		</div>
		<div class="form-group">
		    <label class="info-title" for="exampleInputPassword1">Product Category <span>*</span></label>
		    <input type="text" name ="p_category"class="form-control unicase-form-control text-input" id="exampleInputPassword1" >
		</div>
		<div class="form-group">
		    <label class="info-title" for="exampleInputPassword1">Product Price <span>*</span></label>
		    <input type="text" name ="p_price"class="form-control unicase-form-control text-input" id="exampleInputPassword1" >
		</div>
...
<!-- 		  	<a href="#" class="forgot-password pull-right">Forgot your Password?</a>
 -->		</div>
	  	<button type="submit" name ="action" value ="addproduct" class="btn-upper btn btn-primary checkout-page-button">AddProduct</button>
	</form>					
</div>
<!-- Sign-in -->
...
<!-- <div class="col-md-6 col-sm-6 create-new-account">
	...
	<form class="register-form outer-top-xs" action ="sellercontroller" method ="post" role="form">
		<div class="form-group">
	    	<label class="info-title" for="exampleInputEmail2">Email Address <span>*</span></label>
	    	<input type="email" name ="emailid" class="form-control unicase-form-control text-input" id="exampleInputEmail2" >
	  	</div>
        <div class="form-group">
        ...
        <div class="form-group">
		    ...
		    <input type="text" name ="phoneno" class="form-control unicase-form-control text-input" id="exampleInputEmail1" >
		</div>
        <div class="form-group">
         ...
         <div class="form-group">
		    ...
		    <input type="password" name ="conform" class="form-control unicase-form-control text-input" id="exampleInputEmail1" >
		</div>
	  	<button type="submit" name ="action" value = "Sign Up" class="btn-upper btn btn-primary checkout-page-button">Sign Up</button>
	</form>

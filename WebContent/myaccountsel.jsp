...
<div class="col-md-6 col-sm-6 create-new-account">
	...
	<form class="register-form outer-top-xs" action ="sellercontroller" method ="post" role="form">
		<div class="form-group">
	    	...
	    	<input type="email" name ="emailid" value ="<%=s.getEmailid() %>" class="form-control unicase-form-control text-input" id="exampleInputEmail2" >
	  	</div>
        <div class="form-group">
		    <label class="info-title" for="exampleInputEmail1">Name <span>*</span></label>
		    <input type="text" name ="name" value=" <%=s.getName() %>" class="form-control unicase-form-control text-input" id="exampleInputEmail1" >
		</div>
        <div class="form-group">
		    <label class="info-title" for="exampleInputEmail1">Phone Number <span>*</span></label>
		    <input type="text" name ="phoneno" value="<%=s.getPhoneno() %>" class="form-control unicase-form-control text-input" id="exampleInputEmail1" >
		</div>
        <div class="form-group">
		    <label class="info-title" for="exampleInputEmail1">Password <span>*</span></label>
		    <input type="text" name ="password" value = "<%=s.getPassword() %>" class="form-control unicase-form-control text-input" id="exampleInputEmail1" >
		</div>
         <div class="form-group">
		    <label class="info-title" for="exampleInputEmail1">Confirm Password <span>*</span></label>
		    <input type="password" name ="conform" value = "<%=s.getConform() %>" class="form-control unicase-form-control text-input" id="exampleInputEmail1" >
		</div>

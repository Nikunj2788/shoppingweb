      ...
      <div class="header-top-inner">
        <div class="cnt-account">
          <ul class="list-unstyled">
            <li class="myaccount"><a href="myaccount.jsp"><span>My Account</span></a></li>
            ...
            <div class="nav-outer">
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown"> <a href="contact.jsp">Shoes</a> </li>
                 <li class="dropdown"> <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown">Registration</a>
                      ...
                      <div class="yamm-content">
                        <div class="row">
                          <div class="col-xs-12 col-menu">
                            <ul class="links">
                              <li><a href="registrationcus.jsp">As customer </a></li>
                              <li><a href="registrationsel.jsp">As Seller </a></li>
                ...
                <li class="dropdown"> <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown">Login</a>
                  <ul class="dropdown-menu pages">
                    <li>
                      <div class="yamm-content">
                        <div class="row">
                          <div class="col-xs-12 col-menu">
                            <ul class="links">
                              <li><a href="logincus.jsp">As customer </a></li>
                              <li><a href="loginsel.jsp">As Seller </a></li>
                              <li><a href="adminlogin.jsp">As Admin </a></li>
                              <!-- <li><a href="shopping-cart.jsp">Shopping Cart Summary</a></li>
                              <li><a href="checkout.jsp">Checkout</a></li>
                              <li><a href="blog.jsp">Blog</a></li>
                              <li><a href="blog-details.jsp">Blog Detail</a></li>
    ...
    <div class="row"> 
      ...
      <div class="col-xs-12 col-sm-12 col-md-3 sidebar"> 
            ...
            <div class="item">
              <div class="products">
                ...
                <div class="product-info text-left m-t-20">
                  <h3 class="name"><a href="detail.jsp">Floral Print Buttoned</a></h3>
        ...
        <div class="sidebar-widget product-tag">
          ...
          <div class="sidebar-widget-body outer-top-xs">
            <div class="tag-list"> <a class="item" title="Phone" href="category.jsp">Phone</a> <a class="item active" title="Vest" href="category.html">Vest</a> <a class="item" title="Smartphone" href="category.html">Smartphone</a> <a class="item" title="Furniture" href="category.html">Furniture</a> <a class="item" title="T-shirt" href="category.html">T-shirt</a> <a class="item" title="Sweatpants" href="category.html">Sweatpants</a> <a class="item" title="Sneaker" href="category.html">Sneaker</a> <a class="item" title="Toys" href="category.html">Toys</a> <a class="item" title="Rose" href="category.html">Rose</a> </div>
            <!-- /.tag-list --> 
          </div>
          <!-- /.sidebar-widget-body --> 
        </div>
            ...
            <div class="item" style="background-image: url(assets/images/sliders/01.jpg);">
              <div class="container-fluid">
                <div class="caption bg-color vertical-center text-left">
                  ...
                  <div class="button-holder fadeInDown-3"> <a href="index6c11.jsp?page=single-product" class="btn-lg btn btn-uppercase btn-primary shop-now-button">Shop Now</a> </div>
                </div>
                <!-- /.caption --> 
              </div>
              <!-- /.container-fluid --> 
          ...
          <div class="blog-slider-container outer-top-xs">
            <div class="owl-carousel blog-slider custom-carousel">
              <div class="item">
                <div class="blog-post">
                  <div class="blog-post-image">
                    <div class="image"> <a href="blog.jsp"><img src="assets/images/blog-post/blog_big_01.jpg" alt=""></a> </div>
                  </div>
                  <!-- /.blog-post-image -->
              ...
              <div class="item">
                <div class="blog-post">
                  <div class="blog-post-image">
                    <div class="image"> <a href="blog.jsp"><img src="assets/images/blog-post/blog_big_02.jpg" alt=""></a> </div>
                  </div>
                  <!-- /.blog-post-image -->
              ...
              <div class="item">
                <div class="blog-post">
                  <div class="blog-post-image">
                    <div class="image"> <a href="blog.jsp"><img src="assets/images/blog-post/blog_big_03.jpg" alt=""></a> </div>
                  </div>
                  <!-- /.blog-post-image -->
        ...
        <div class="col-xs-12 col-sm-6 col-md-3">
          ...
          <div class="module-body">
            <ul class='list-unstyled'>
              ...
              <li class=" last"><a href="contact-us.jsp" title="Suppliers">Contact Us</a></li>
            </ul>
          </div>
          <!-- /.module-body --> 
        </div>
